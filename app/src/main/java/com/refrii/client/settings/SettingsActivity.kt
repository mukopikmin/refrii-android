    ...
    class GeneralPreferenceFragment : PreferenceFragment() {
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            termsOfServicePreference.onPreferenceClickListener = Preference.OnPreferenceClickListener {
                ...
                intent.putExtra("url", "https://refrii.com/termsofservice")
                startActivity(intent)
                true
            }

            val privacyPolicyPreference = findPreference("privacy_policy")
            privacyPolicyPreference.onPreferenceClickListener = Preference.OnPreferenceClickListener {
                val intent = Intent(activity, WebViewActivity::class.java)
                intent.putExtra("url", "https://refrii.com/privacypolicy")
                startActivity(intent)
                true
            }

            val ossLicensePreference = findPreference("oss_license")
            ossLicensePreference.onPreferenceClickListener = Preference.OnPreferenceClickListener {
                val intent = Intent(activity, WebViewActivity::class.java)
